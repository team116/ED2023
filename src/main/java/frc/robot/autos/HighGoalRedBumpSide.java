...
public class HighGoalRedBumpSide extends BaseHighGoalCone {

    public HighGoalRedBumpSide(Swerve swerveSubsystem, Arm armSubsystem, Grabber grabberSubsystem, Limelight limelight) {
