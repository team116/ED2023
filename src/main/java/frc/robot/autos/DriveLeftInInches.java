...
public class DriveLeftInInches extends CommandBase{
    private SwerveModulePosition [] listOfModulePositions = new SwerveModulePosition[4];
    private Swerve swerve;
    private int pidSlot = 0;
    private Rotation2d angle = Rotation2d.fromDegrees(270.0d);
    private double distance;
    private Timer timer;

    public DriveLeftInInches(Swerve swerveSubsystem, double distanceInches, int pidSlot){
